...
注意：如果您使用2.4及以前的Paddle，请参考[release/2.4分支](https://github.com/PaddlePaddle/Paddle-Inference-Demo/tree/release/2.4)

如果您使用2.0以前的Paddle，请参考[release/1.8分支](https://github.com/PaddlePaddle/Paddle-Inference-Demo/tree/release/1.8)
